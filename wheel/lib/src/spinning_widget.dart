...
class _SpinningWidgetState extends State<SpinningWidget> {
          ...
          (idx) {
            ...
            return CustomPaint(
              ...
              painter: PiceOfCakePainter(
                bgColor:idx==0 ? Colors.pinkAccent: bgColor(idx),
  ...
  bgColor(int idx) {
    switch (idx%3) {
      case 0:
        return Color(0xFFFDECD0);
      case 1:
        return Color(0xFFBCD0C5);
      case 2:
        return Color(0xFF91BFBF);
    /*  case 3:
        return Color(0xFF528870);
      case 4:
        return Color(0xFF1D2F3B);*/
      default:
        return Color(0xFFFDECD0);
    }
  }
